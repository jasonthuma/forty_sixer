...
export const registerUser = asyncHandler(handleRegister);
...
export const loginUser = asyncHandler(handleLogin);
...
export const forgotPassword = asyncHandler(handleForgotPassword);
...
export async function handleForgotPassword(req: Request, res: Response) {
  ...
  if (userDb) {
    await sendEmail(email, userDb.id, redirectUrl);
...
export const resetPassword = asyncHandler(handleResetPassword);
...
export const getLoggedUser = asyncHandler(handleGetLoggedUser);

export async function handleGetLoggedUser(req: Request, res: Response) {
  const userDb = await userRepo.findOneBy({
    id: req.user.id,
  });
